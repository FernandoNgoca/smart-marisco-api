...
public class TokenDTO implements Serializable {
	...
	@Override
	public int hashCode() {
		return Objects.hash(accessToken, authenticated, created, expiration, refreshToken, user, username);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(accessToken, other.accessToken) && Objects.equals(authenticated, other.authenticated)
				...
				&& Objects.equals(refreshToken, other.refreshToken) && Objects.equals(user, other.user)
